...
import pandas as pd
import pytest
from history_matching.core.builder import HistoryMatchingBuilder
from history_matching.core.builder import advanced_setup
from history_matching.core.builder import quick_setup
...
from history_matching.strategies.feature_selection import AutoFeatureSelection
from history_matching.strategies.feature_selection import ManualFeatureSelection
from history_matching.strategies.sampling import RandomSampling
...
class TestConvenienceFunctions:
    ...
    def test_advanced_setup(self):
        ...
        observations_df = pd.DataFrame({
            ...
            "mean": [5.0, 10.0],
            "std": [1.0, 2.0]  # sqrt of previous variance values
        })
