...
def main():
    ...
    # Step 2: Quick setup using convenience function
    print("\n🏗️  Building history matching engine...")
...
def interactive_example():
    ...
    engine = (hm.HistoryMatchingBuilder
              .from_data(parameter_bounds, observations)
              .with_sampling_strategy('lhs')
              .with_feature_selection(['peak_infections'])  # Start with one feature
    ...
    print("🏗️  Interactive engine built")
...
def advanced_configuration_example():
    ...
    builder = (hm.HistoryMatchingBuilder
               .from_dataframes(parameter_df, observations_df)
               ...
               .with_emulator_type('gpr', kernel='matern52')
               .with_samples_per_iteration(800)
               .with_max_iterations(8)
               .with_implausibility_threshold(2.8)
               .with_space_reduction(True)  # Enable space reduction
               .with_oversample_factor(4.0)  # Higher oversampling
