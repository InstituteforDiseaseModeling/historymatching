...
# pygments_style = 'trac'     # overriden below
# templates_path = ['.']      # overriden below
extlinks = {
    'issue': ('https://github.com/InstituteforDiseaseModeling/history_matching/issues/%s', '#'),
    'pr': ('https://github.com/InstituteforDiseaseModeling/history_matching/pull/%s', 'PR #'),
}
...
latex_documents = [
    (master_doc, 'history_matching-docs.tex', u'History Matching',
     u'Christopher Lorton', 'manual'),
]
...
man_pages = [
    (master_doc, 'history_matching-docs', u'History Matching',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'history_matching-docs', u'History Matching',
     author, 'Christopher Lorton', 'Implementation of Bayesian History Matching, in Python, for model calibration.',
     'Miscellaneous'),
]
