...
The library includes four [emulator](glossary.qmd#emulator) types:
...
not been ruled out as [implausible](glossary.qmd#implausibility) — see the
[Glossary](glossary.qmd#nroy).
