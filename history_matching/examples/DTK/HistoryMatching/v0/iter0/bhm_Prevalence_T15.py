...
sim_results_all = sim_results_all.reset_index().set_index(['Timestep', 'Sample_Id', 'Sim_Id'])
...
discrepancy_std = 0.1 #0.10 * desired_result
...
try:
    ...
    basis_gpr.plot_regularize(inputs, results_err, alpha = np.logspace(-4, 1, 25), scaleX=True)
...
hm.calc_and_plot_implausibility(
    plot=True,
    do_plot_data=False,
    plot_data_highlight=pd.DataFrame() # plot_data_highlight=hm.training_data.loc['8c7e4af7-1120-e711-9400-f0921c16849c.003328']
) 
