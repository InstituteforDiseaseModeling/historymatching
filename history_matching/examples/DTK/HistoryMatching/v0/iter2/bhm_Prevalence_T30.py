...
exp_ids = ['prime', 'iter1prime', 'iter0prime']#, 'iter2prime', 'iter1prime']
...
try:
    with open(os.path.join('Cuts', cut_name, 'basis_gpr.json'), 'rb') as data_file:
        config = json.load( data_file )
