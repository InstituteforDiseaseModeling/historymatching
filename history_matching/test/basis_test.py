...
class BasisTest(unittest.TestCase):
    ...
    def test_polynomial_third(self):
        data = pd.DataFrame({'x':[1,2,3],'y':[4,5,6],'z':[7,8,9]})
        b = Basis.make_polynomial_basis(params=data.keys(), intercept=True, first_order=True, second_order=True, third_order=True)
    ...
    def test_polynomial_fourth(self):
        data = pd.DataFrame({'x':[1,2,3],'y':[4,5,6],'z':[7,8,9]})
        b = Basis.make_polynomial_basis(params=data.keys(), intercept=True, first_order=True, second_order=True, third_order=True, fourth_order=True)
    ...
    def test_polynomial_fifth(self):
        data = pd.DataFrame({'x':[1,2,3],'y':[4,5,6],'z':[7,8,9]})
        b = Basis.make_polynomial_basis(params=data.keys(), intercept=True, first_order=True, second_order=True, third_order=True, fourth_order=True, fifth_order=True)
    ...
    def test_polynomial_higher(self):
        data = pd.DataFrame({'x':[1,2,3],'y':[4,5,6],'z':[7,8,9]})
        b = Basis.make_polynomial_basis(params=data.keys(), intercept=True, first_order=True, second_order=True, third_order=True, fourth_order=True, fifth_order=True, higher_order=True)
