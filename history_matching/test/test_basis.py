...
class BasisTest(unittest.TestCase):
    ...
    def test_naming(self):
        # test creation of param dict (mapping of original name to patsy safe string);
    ...
    def test_polynomial_intercept(self):
        # test polynomial basis creation with intercept
        data = pd.DataFrame({'x':[1,2,3],'y':[4,5,6],'z':[7,8,9]})
    ...
    def test_polynomial_first(self):
        # test polynomial basis with first-order terms
        data = pd.DataFrame({'x':[1,2,3],'y':[4,5,6],'z':[7,8,9]})
    ...
    def test_polynomial_third(self):
        # test polynomial basis with 3rd-order terms
        data = pd.DataFrame({'x':[1,2,3],'y':[4,5,6],'z':[7,8,9]})
    ...
    def test_polynomial_fourth(self):
        # test polynomial basis with 4th-order terms
        data = pd.DataFrame({'x':[1,2,3],'y':[4,5,6],'z':[7,8,9]})
    ...
    def test_polynomial_fifth(self):
        # test polynomial basis with 5th-order terms
        data = pd.DataFrame({'x':[1,2,3],'y':[4,5,6],'z':[7,8,9]})
    ...
    def test_polynomial_higher(self):
        # test polynomial basis with higher order terms
        data = pd.DataFrame({'x':[1,2,3],'y':[4,5,6],'z':[7,8,9]})
